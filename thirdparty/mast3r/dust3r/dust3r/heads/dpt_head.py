...
class DPTOutputAdapter_fix(DPTOutputAdapter):
    ...
    def forward(self, encoder_tokens: List[torch.Tensor], image_size=None):
        ...
        if self.head_type in ['regression', 'semseg']:
            ...
            path_2 = self.head_fusion2(path_3, layers[1])
            layers_0_down = self.downsample_l0(layers[0])
            path_1 = self.head_fusion1(path_2, layers_0_down)
